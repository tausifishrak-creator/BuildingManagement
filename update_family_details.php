...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        // Prepare the SQL statement to UPDATE family details using phone_number
        $sql = "UPDATE family_details SET adults = ?, children = ? WHERE phone_number = ?";
        ...
        $stmt->bind_param("iis", $adults, $children, $phone_number);

        if ($stmt->execute()) {
            $_SESSION['success_message'] = "Family details updated successfully!";
        } else {
