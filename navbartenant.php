...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="tenant.php">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="tenant.php"><i class="bi bi-house-door-fill"></i> Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="tenantview_announcements.php"><i class="bi bi-megaphone-fill"></i> Announcement
                ...
                <!-- Other Navbar Links -->
                <li class="nav-item">
                    <a class="nav-link" href="complaintstenant.php"><i class="bi bi-chat-dots-fill"></i> Contact us</a>
                </li>
                <li class="nav-item">
